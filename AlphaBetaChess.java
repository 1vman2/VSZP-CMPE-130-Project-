...
public class AlphaBetaChess {
    ...
    static int playerAsWhite = -1; // 1 means players are White and 0 means players are Black 
    ...
    public static void main(String[] args) {
        ...
        playerAsWhite=JOptionPane.showOptionDialog (null, "Who should play as the white pieces!", "ABC Options", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, 
